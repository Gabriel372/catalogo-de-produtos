...
function CloseForm(e: React.FormEvent<HTMLFormElement>) {
 e.preventDefault()
  console.log('ok')
}

    return<form onSubmit={ClickUpdate} className={`absolute border rounded-lg bg-gray-200 p-1 shadow-xl ${FormEdit.formIsOpen && 'visible'}`}>
